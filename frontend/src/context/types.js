// menu context
export const PIZZA_MENU = "PIZZA_MENU";
export const CHICKEN_MENU = "CHICKEN_MENU";
export const COMPLETE_MENU = "COMPLETE_MENU";
...
export const SEARCH_ORDER_FORM_VISIBLE = "SEARCH_ORDER_FORM_VISIBLE";
// payment context
...
// CLICKTEL API KEY
export const API_KEY = "MN76LN-dTmmbJhj-88hQLw==";
// store phone number:
